...
Shader "QFSW/Blur"
{
    ...
    Category
    {
        ...
        float scale = 1.0;
                ...
                half4 frag(v2f i) : COLOR
                {
                    half4 blurredCol = tex2Dproj(_GrabTexture, UNITY_PROJ_COORD(i.uvgrab));
                    // Gets the color of what is behind it and blurred
                    ...
                    // Blends it with the overlay color
                    col *= i.color;
                    col = blurredCol * (1 - texCol.a) + col * texCol.a;
                    // Blends it using the tex color so transparent regions stay transparent
